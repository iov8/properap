...
export function trackAnalyticsEvent(input: { eventName: AnalyticsEventName; listingId?: string; siteId?: string; inquiryId?: string; metadata?: Record<string, string | number | boolean> }) {
  void fetch("/api/analytics/events", { method: "POST", credentials: "same-origin", keepalive: true, headers: { "content-type": "application/json" }, body: JSON.stringify({ ...input, eventId: crypto.randomUUID() }) });
}
